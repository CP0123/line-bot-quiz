...
async function handleEvent(event) {
        ...
        contents: [
          {
            ...
            hero: {
              type: 'image',
              url: 'https://olis.kmu.edu.tw/images/game/Instruction/1.png',
              size: 'full',
              aspectRatio: '9:16',
              aspectMode: 'cover',
              action: {
          ...
          },
          {
            ...
            hero: {
              type: 'image',
              url: 'https://olis.kmu.edu.tw/images/game/Instruction/6.png',
              size: 'full',
              aspectRatio: '9:16',
              aspectMode: 'cover'
            },
  ...
  try {
    ...
    const allCodes = questions.map(q => q.code.toUpperCase());
    ...
    const completedCodes = answered?.map(a => a.question_code.toUpperCase()) ?? [];
...
if (userMessage === '更多題目') {
  userState[userId] = userState[userId] || { questionOffset: 0 };
